    ...
    var accordionJS = function accordionJS() {
      ...
      if (block.length) {
        ...
        headings.on("click", function () {
          var $parent = $(this).closest(".single-accordion");
          if (!$parent.hasClass("active")) {
            block.find(".single-accordion.active").find(".accordion-content").stop().slideUp();
            block.find(".single-accordion.active").find(".accordion-heading").attr("aria-expanded", "false");
...
})(window, document, (jquery__WEBPACK_IMPORTED_MODULE_3___default()));
...
/******/ 	__webpack_require__.O(undefined, ["dist/main.min"], () => (__webpack_require__("./js/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/main.min"], () => (__webpack_require__("./scss/main.scss")))
